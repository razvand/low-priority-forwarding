...
lines(pps_gen, pps_start, type = "b", col = "green", pch=2)
lines(pps_gen, pps_fw_in, type = "b", col = "blue", pch=3)
lines(pps_gen, pps_fw_out, type = "b", col = "orange", pch=4)
lines(pps_gen, pps_end, type = "b", col = "blueviolet", pch=5)
