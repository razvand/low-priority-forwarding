...
basename <- paste(exp_name, "-normal-pktsize60-fw-rt", sep="")
...
basename <- paste(exp_name, "-ipt-block-pktsize60-fw-rt", sep="")
...
basename <- paste(exp_name, "-fw-disable-pktsize60-fw-rt", sep="")
...
basename <- paste(exp_name, "-50perc-block-pktsize60-fw-rt", sep="")
...
pdf(paste(exp_name, "-packet60-cumulative.pdf", sep=""))

# Plot running time when forwarding versus when not forwarding.
# Horizontal axis is number of generated packets.

plot(pps_gen_normal, time_gen_normal, type = "b", xlab = "Kilopackets per second (Kpps)", ylab = "Running Time (seconds)", col = "red", xaxt="n", ylim=c(mn-5,mx+5), pch=1)
axis(1, at=pps, labels=sprintf("%.0f", pps/1000))
title(main=paste(exp_name, "Running Time"), sub="cumulative generated")
legend("topleft", c("normal", "ipt-block", "fw-disable", "50perc-block", "no-forward"), fill=c('red', 'green', 'blue', 'orange', 'yellow'))
lines(pps_gen_ipt, time_gen_ipt, type = "b", col = "green", pch=2) #, ylim=c(45,))
lines(pps_gen_fwdis, time_gen_fwdis, type = "b", col = "blue", pch=3) #, ylim=c(45,))
lines(pps_gen_50perc, time_gen_50perc, type = "b", col = "orange", pch=4) #, ylim=c(45,))
lines(pps_gen_normal, time_nofw, col = "yellow", pch=6) #, ylim=c(45,))

## Plot running time when forwarding versus when not forwarding.
## Horizontal axis is number of packets on sender interface.

plot(pps_start_normal, time_gen_normal, type = "b", xlab = "Kilopackets per second (Kpps)", ylab = "Running Time (seconds)", col = "red", xaxt="n", ylim=c(mn-5,mx+5), pch=1)
axis(1, at=pps, labels=sprintf("%.0f", pps/1000))
title(main=paste(exp_name, "Running Time"), sub="cumulative sender")
legend("topleft", c("normal", "ipt-block", "fw-disable", "50perc-block", "no-forward"), fill=c('red', 'green', 'blue', 'orange', 'yellow'))
lines(pps_start_ipt, time_gen_ipt, type = "b", col = "green", pch=2) #, ylim=c(45,))
lines(pps_start_fwdis, time_gen_fwdis, type = "b", col = "blue", pch=3) #, ylim=c(45,))
lines(pps_start_50perc, time_gen_50perc, type = "b", col = "orange", pch=4) #, ylim=c(45,))
lines(pps_start_normal, time_nofw, col = "yellow", pch=6) #, ylim=c(45,))

## Plot running time when forwarding versus when not forwarding.
## Horizontal axis is number of packets on forwarder in interface.

plot(pps_fw_in_normal, time_gen_normal, type = "b", xlab = "Kilopackets per second (Kpps)", ylab = "Running Time (seconds)", col = "red", xaxt="n", ylim=c(mn-5,mx+5), pch=1)
axis(1, at=pps, labels=sprintf("%.0f", pps/1000))
title(main=paste(exp_name, "Running Time"), sub="cumulative fowarder-in")
legend("topleft", c("normal", "ipt-block", "fw-disable", "50perc-block", "no-forward"), fill=c('red', 'green', 'blue', 'orange', 'yellow'))
lines(pps_fw_in_ipt, time_gen_ipt, type = "b", col = "green", pch=2) #, ylim=c(45,))
lines(pps_fw_in_fwdis, time_gen_fwdis, type = "b", col = "blue", pch=3) #, ylim=c(45,))
lines(pps_fw_in_50perc, time_gen_50perc, type = "b", col = "orange", pch=4) #, ylim=c(45,))
lines(pps_fw_in_normal, time_nofw, col = "yellow", pch=6) #, ylim=c(45,))

## Plot running time when forwarding versus when not forwarding.
## Horizontal axis is number of packets on forwarder out interface.

plot(pps_fw_out_normal, time_gen_normal, type = "b", xlab = "Kilopackets per second (Kpps)", ylab = "Running Time (seconds)", col = "red", xaxt="n", ylim=c(mn-5,mx+5), pch=1)
axis(1, at=pps, labels=sprintf("%.0f", pps/1000))
title(main=paste(exp_name, "Running Time"), sub="cumulative forwarder-out")
legend("topleft", c("normal", "ipt-block", "fw-disable", "50perc-block", "no-forward"), fill=c('red', 'green', 'blue', 'orange', 'yellow'))
lines(pps_fw_out_ipt, time_gen_ipt, type = "b", col = "green", pch=2) #, ylim=c(45,))
lines(pps_fw_out_fwdis, time_gen_fwdis, type = "b", col = "blue", pch=3) #, ylim=c(45,))
lines(pps_fw_out_50perc, time_gen_50perc, type = "b", col = "orange", pch=4) #, ylim=c(45,))
lines(pps_fw_out_normal, time_nofw, col = "yellow", pch=6) #, ylim=c(45,))

## Plot running time when forwarding versus when not forwarding.
## Horizontal axis is number of packets on receiver interface.

plot(pps_end_normal, time_gen_normal, type = "b", xlab = "Kilopackets per second (Kpps)", ylab = "Running Time (seconds)", col = "red", xaxt="n", ylim=c(mn-5,mx+5), pch=1)
axis(1, at=pps, labels=sprintf("%.0f", pps/1000))
title(main=paste(exp_name, "Running Time"), sub="cumulative receiver")
legend("topleft", c("normal", "ipt-block", "fw-disable", "50perc-block", "no-forward"), fill=c('red', 'green', 'blue', 'orange', 'yellow'))
lines(pps_end_ipt, time_gen_ipt, type = "b", col = "green", pch=2) #, ylim=c(45,))
lines(pps_end_fwdis, time_gen_fwdis, type = "b", col = "blue", pch=3) #, ylim=c(45,))
lines(pps_end_50perc, time_gen_50perc, type = "b", col = "orange", pch=4) #, ylim=c(45,))
lines(pps_end_normal, time_nofw, col = "yellow", pch=6) #, ylim=c(45,))
